...
<body>
	<header>
		<a href="${pageContext.request.contextPath}/main/main.do"> <img
			id="backButton"
			src="${pageContext.request.contextPath}/img/back_icon.png"
			alt="뒤로 가기" />
		</a> <span class="myText">MY</span> <img class="settingsIcon"
			src="${pageContext.request.contextPath}/img/settings_icon.png"
			alt="환경설정" /> <img class="alarmIcon"
			src="${pageContext.request.contextPath}/img/alarm_icon.png" alt="알림" />
	</header>
	<div class="container">
		<div class="profile">
			<input type="file" id="file_input" style="display: none;"
				accept="image/*"> <img id="profile_image"
				src="${pageContext.request.contextPath}/img/Profile_image.png"
				alt="프로필 이미지" />
			<p class="name">조상철님</p>
		</div>
		<div class="paymentInformation">
			<div class="payUnlimited">
				...
				<div class="textContainer">
					...
					<p class="paymentDescription" id="description_1">헤어질 때까지 커플임을
						인증 할 수 있어요.</p>
				</div>
				<a href="${pageContext.request.contextPath}/member/payUnlimited">
					<img class="bigRight" id="br_1"
			...
			<div class="paymentInformation">
				<div class="payAnnual">
					...
					<div class="textContainer">
						...
						<p class="paymentDescription" id="description_2">1년간 커플임을 인증 할
							수 있어요.</p>
					</div>
					<a href="${pageContext.request.contextPath}/member/payAnnual">
						<img class="bigRight" id="br_2"
						src="${pageContext.request.contextPath}/img/Big_right.png"
						alt=">(클릭 시 진입)" />
					</a>
				</div>
			...
			<div class="accountSettings">
				...
				<div class="contact">
					<img class="Icon"
						src="${pageContext.request.contextPath}/img/phone.png"
						alt="전화기 이미지" /> <span class="accountSettingsText_1">연락처</span> <span
						class="accountSettingsText_2">82 10 12345678</span> <img
						class="smallRight"
				...
				<div class="email">
					<img class="Icon"
						src="${pageContext.request.contextPath}/img/message.png"
						alt="이메일 이미지" /> <span class="accountSettingsText_1">이메일</span> <span
						class="accountSettingsText_2">TEST@TEST.CO.KR</span> <img
						class="smallRight"
						src="${pageContext.request.contextPath}/img/right.png"
						alt=">(클릭 시 진입)" />
				</div>
				<div class="firstMeetingDate">
					<img class="Icon"
						src="${pageContext.request.contextPath}/img/calander.png"
						alt="달력 이미지" /> <span class="accountSettingsText_1">처음 만난
						날</span> <span class="accountSettingsText_2">2022. 03. 04</span> <img
						class="smallRight"
						src="${pageContext.request.contextPath}/img/right.png"
						alt=">(클릭 시 진입)" />
				</div>
	...
	<div class="modal">
		<img class="whiteBar"
			src="${pageContext.request.contextPath}/img/Handlebar.png"
			alt="하얀 막대" />
	...
	document.addEventListener("DOMContentLoaded", function() {
		...
		<!--프로필 사진 클릭 시, 프로필 이미지 변경 가능-->
		// 프로필 이미지 클릭 시, 파일 선택 창 열기
		document.querySelector("#profile_image").addEventListener("click", function() {
